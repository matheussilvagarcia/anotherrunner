...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Future<void> _shareRunCard(String date, String distance) async {
    setState(() {
      _isSharing = true;
    });
    ...
    try {
      ...
      if (imageBytes != null) {
        ...
        final imagePath = await File('${directory.path}/shared_run.png').create();
        ...
        await Share.shareXFiles(
          [xFile],
          text: 'Check out my run on AnotherRunner on $date: $distance km!',
        );
      }
    } catch (e) {
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            if (_isSharing)
                              ...
                              IconButton(
                                ...
                                onPressed: () => _shareRunCard(formattedDate, formattedDistance),
                              ),
                          ],
                        ),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            _buildMiniMetric(Icons.timer, _formatTime(duration)),
                            _buildMiniMetric(Icons.speed, '${_formatPace(pace)} /km'),
                          ],
                        ),
                      ],
                    ),
